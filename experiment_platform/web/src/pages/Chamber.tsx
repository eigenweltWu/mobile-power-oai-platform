...
export default function Chamber({ onBack }: { initialExperimentId?: string; onBack?: () => void }) {
  ...
  return <div className="stack">
    ...
    <div className="stat-grid">
      <StatCard label="Controller" value={status?.connected ? 'CONNECTED' : 'DISCONNECTED'} sub={status?.last_error || `MT_API · ${port || 'USB auto'}`} tone={status?.connected ? 'good' : 'bad'} />
