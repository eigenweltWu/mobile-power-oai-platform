...
type Sample = { id: number; elapsed_realtime_ns: number; battery_power_w: number | null; ss_rsrp_dbm: number | null; run_id: string };
    ...
    <div className="stack">
      <div className="page-head">
        <div>
          ...
          <div className="subtitle">phone power / RSRP timeline with ACK markers</div>
        </div>
      </div>
